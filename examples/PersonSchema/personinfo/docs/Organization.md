...
[![img](https://yuml.me/diagram/nofunky;dir:TB/class/[Place],[Place]<founding_location%200..1-%20[Organization&#124;mission_statement:string%20%3F;founding_date:string%20%3F;categories:OrganizationType%20*;score:decimal%20%3F;min_salary:SalaryType%20%3F;aliases:string%20*;id(i):uriorcurie;name(i):string%20%3F;description(i):string%20%3F;depicted_by(i):ImageURL%20%3F],[EmploymentEvent]-%20employed_at%200..1>[Organization],[Container]++-%20organizations%200..*>[Organization],[Organization]uses%20-.->[HasAliases],[NamedThing]^-[Organization],[NamedThing],[HasAliases],[EmploymentEvent],[Container])](https://yuml.me/diagram/nofunky;dir:TB/class/[Place],[Place]<founding_location%200..1-%20[Organization&#124;mission_statement:string%20%3F;founding_date:string%20%3F;categories:OrganizationType%20*;score:decimal%20%3F;min_salary:SalaryType%20%3F;aliases:string%20*;id(i):uriorcurie;name(i):string%20%3F;description(i):string%20%3F;depicted_by(i):ImageURL%20%3F],[EmploymentEvent]-%20employed_at%200..1>[Organization],[Container]++-%20organizations%200..*>[Organization],[Organization]uses%20-.->[HasAliases],[NamedThing]^-[Organization],[NamedThing],[HasAliases],[EmploymentEvent],[Container])
