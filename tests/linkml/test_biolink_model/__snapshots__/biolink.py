...
ASPGD = CurieNamespace(
    "AspGD", "http://www.aspergillusgenome.org/cgi-bin/locus.pl?dbid="
)
BFO = CurieNamespace("BFO", "http://purl.obolibrary.org/obo/BFO_")
BIGG_METABOLITE = CurieNamespace(
    "BIGG_METABOLITE", "http://identifiers.org/bigg.metabolite/"
)
...
CATH_SUPERFAMILY = CurieNamespace(
    "CATH_SUPERFAMILY", "http://identifiers.org/cath.superfamily/"
)
CDD = CurieNamespace("CDD", "http://identifiers.org/cdd/")
CHADO = CurieNamespace("CHADO", "http://gmod.org/wiki/Chado/")
CHEBI = CurieNamespace("CHEBI", "http://purl.obolibrary.org/obo/CHEBI_")
CHEMBL_COMPOUND = CurieNamespace(
    "CHEMBL_COMPOUND", "http://identifiers.org/chembl.compound/"
)
CHEMBL_MECHANISM = CurieNamespace(
...
CTD_CHEMICAL = CurieNamespace(
    "CTD_CHEMICAL", "http://ctdbase.org/detail.go?type=chem&acc="
)
CTD_DISEASE = CurieNamespace(
...
KEGG_ORTHOLOGY = CurieNamespace(
    "KEGG_ORTHOLOGY", "http://identifiers.org/kegg.orthology/"
)
KEGG_PATHWAY = CurieNamespace("KEGG_PATHWAY", "https://bioregistry.io/kegg.pathway:")
KEGG_RCLASS = CurieNamespace(
    "KEGG_RCLASS", "https://www.genome.jp/dbget-bin/www_bget?rc:"
)
...
METANETX_REACTION = CurieNamespace(
    "METANETX_REACTION", "https://www.metanetx.org/equa_info/"
)
...
PANTHER_FAMILY = CurieNamespace(
    "PANTHER_FAMILY", "http://www.pantherdb.org/panther/family.do?clsAccession="
)
PANTHER_PATHWAY = CurieNamespace(
    "PANTHER_PATHWAY", "http://identifiers.org/panther.pathway/"
)
PATO = CurieNamespace("PATO", "http://purl.obolibrary.org/obo/PATO_")
PCO = CurieNamespace("PCO", "http://purl.obolibrary.org/obo/PCO_")
PFAM = CurieNamespace("PFAM", "http://identifiers.org/pfam/")
PHARMGKB_DISEASE = CurieNamespace(
    "PHARMGKB_DISEASE", "https://www.pharmgkb.org/disease/"
)
...
PHARMGKB_PATHWAYS = CurieNamespace(
    "PHARMGKB_PATHWAYS", "https://www.pharmgkb.org/pathway/"
)
PHARMGKB_VARIANT = CurieNamespace(
    "PHARMGKB_VARIANT", "https://www.pharmgkb.org/variant/"
)
...
PUBCHEM_COMPOUND = CurieNamespace(
    "PUBCHEM_COMPOUND", "http://identifiers.org/pubchem.compound/"
)
PUBCHEM_SUBSTANCE = CurieNamespace(
...
SEED_REACTION = CurieNamespace(
    "SEED_REACTION", "https://modelseed.org/biochem/reactions/"
)
...
WIKIDATA_PROPERTY = CurieNamespace(
...
METACYC_REACTION = CurieNamespace(
    "metacyc_reaction", "http://identifiers.org/metacyc.reaction:"
)
...
NCATS_BIOPLANET = CurieNamespace(
...
class GeneToPhenotypicFeatureAssociationId(
    GeneToDiseaseOrPhenotypicFeatureAssociationId
):
    pass
...
class CellLineAsAModelOfDiseaseAssociationId(
...
class AnatomicalEntityToAnatomicalEntityPartOfAssociationId(
    AnatomicalEntityToAnatomicalEntityAssociationId
):
    pass


class AnatomicalEntityToAnatomicalEntityOntogenicAssociationId(
    AnatomicalEntityToAnatomicalEntityAssociationId
):
    pass
...
class OrganismTaxonToOrganismTaxonSpecializationId(
    OrganismTaxonToOrganismTaxonAssociationId
):
    pass


class OrganismTaxonToOrganismTaxonInteractionId(
    OrganismTaxonToOrganismTaxonAssociationId
):
    pass
...
class MappingCollection(YAMLRoot):
    ...
    predicate_mappings: Optional[
        Union[Union[dict, "PredicateMapping"], list[Union[dict, "PredicateMapping"]]]
    ] = empty_list()

    def __post_init__(self, *_: str, **kwargs: Any):
        if not isinstance(self.predicate_mappings, list):
            self.predicate_mappings = (
                [self.predicate_mappings] if self.predicate_mappings is not None else []
            )
        self.predicate_mappings = [
            v if isinstance(v, PredicateMapping) else PredicateMapping(**as_dict(v))
            for v in self.predicate_mappings
        ]
...
class PredicateMapping(YAMLRoot):
    ...
    causal_mechanism_qualifier: Optional[Union[str, "CausalMechanismQualifierEnum"]] = (
        None
    )
    ...
    narrow_match: Optional[
        Union[Union[str, NamedThingId], list[Union[str, NamedThingId]]]
    ] = empty_list()
    broad_match: Optional[
        Union[Union[str, NamedThingId], list[Union[str, NamedThingId]]]
    ] = empty_list()
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        if self.mapped_predicate is not None and not isinstance(
            self.mapped_predicate, str
        ):
            self.mapped_predicate = str(self.mapped_predicate)

        if self.subject_aspect_qualifier is not None and not isinstance(
            self.subject_aspect_qualifier, str
        ):
        ...
        if self.subject_direction_qualifier is not None and not isinstance(
            ...
            self.subject_direction_qualifier = DirectionQualifierEnum(
                self.subject_direction_qualifier
            )
        ...
        if self.subject_part_qualifier is not None and not isinstance(
            self.subject_part_qualifier, str
        ):
        ...
        if self.subject_derivative_qualifier is not None and not isinstance(
            self.subject_derivative_qualifier, str
        ):
        ...
        if self.object_direction_qualifier is not None and not isinstance(
            ...
            self.object_direction_qualifier = DirectionQualifierEnum(
                self.object_direction_qualifier
            )
        ...
        if self.object_part_qualifier is not None and not isinstance(
            self.object_part_qualifier, str
        ):
        ...
        if self.object_derivative_qualifier is not None and not isinstance(
            self.object_derivative_qualifier, str
        ):
        ...
        if self.object_context_qualifier is not None and not isinstance(
            self.object_context_qualifier, str
        ):
        ...
        if self.causal_mechanism_qualifier is not None and not isinstance(
            ...
            self.causal_mechanism_qualifier = CausalMechanismQualifierEnum(
                self.causal_mechanism_qualifier
            )

        if self.anatomical_context_qualifier is not None and not isinstance(
            self.anatomical_context_qualifier, str
        ):
        ...
        if self.species_context_qualifier is not None and not isinstance(
            ...
            self.species_context_qualifier = OrganismTaxonId(
                self.species_context_qualifier
            )

        if not isinstance(self.exact_match, list):
            self.exact_match = (
                [self.exact_match] if self.exact_match is not None else []
            )
        self.exact_match = [
            v if isinstance(v, NamedThingId) else NamedThingId(v)
            for v in self.exact_match
        ]

        if not isinstance(self.narrow_match, list):
            self.narrow_match = (
                [self.narrow_match] if self.narrow_match is not None else []
            )
        self.narrow_match = [
            v if isinstance(v, NamedThingId) else NamedThingId(v)
            for v in self.narrow_match
        ]

        if not isinstance(self.broad_match, list):
            self.broad_match = (
                [self.broad_match] if self.broad_match is not None else []
            )
        self.broad_match = [
            v if isinstance(v, NamedThingId) else NamedThingId(v)
            for v in self.broad_match
        ]
...
class QuantityValue(Annotation):
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        if self.has_numeric_value is not None and not isinstance(
            self.has_numeric_value, float
        ):
...
class FrequencyQuantifier(RelationshipQuantifier):
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        if self.has_percentage is not None and not isinstance(
            self.has_percentage, float
        ):
...
class Entity(YAMLRoot):
    ...
    category: Optional[Union[Union[str, URIorCURIE], list[Union[str, URIorCURIE]]]] = (
        empty_list()
    )
    ...
    has_attribute: Optional[
        Union[Union[str, AttributeId], list[Union[str, AttributeId]]]
    ] = empty_list()
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        self.category = [
            v if isinstance(v, URIorCURIE) else URIorCURIE(v) for v in self.category
        ]
        ...
        if not isinstance(self.has_attribute, list):
            self.has_attribute = (
                [self.has_attribute] if self.has_attribute is not None else []
            )
        self.has_attribute = [
            v if isinstance(v, AttributeId) else AttributeId(v)
            for v in self.has_attribute
        ]
...
class NamedThing(Entity):
    ...
    xref: Optional[Union[Union[str, URIorCURIE], list[Union[str, URIorCURIE]]]] = (
        empty_list()
    )
    full_name: Optional[Union[str, LabelType]] = None
    synonym: Optional[Union[Union[str, LabelType], list[Union[str, LabelType]]]] = (
        empty_list()
    )
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        if not isinstance(self.provided_by, list):
            self.provided_by = (
                [self.provided_by] if self.provided_by is not None else []
            )
        self.provided_by = [
            v if isinstance(v, str) else str(v) for v in self.provided_by
        ]

        if not isinstance(self.xref, list):
            self.xref = [self.xref] if self.xref is not None else []
        self.xref = [
            v if isinstance(v, URIorCURIE) else URIorCURIE(v) for v in self.xref
        ]
        ...
        self.synonym = [
            v if isinstance(v, LabelType) else LabelType(v) for v in self.synonym
        ]
...
class Attribute(NamedThing):
    ...
    has_quantitative_value: Optional[
        Union[Union[dict, QuantityValue], list[Union[dict, QuantityValue]]]
    ] = empty_list()
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        if not isinstance(self.has_quantitative_value, list):
            self.has_quantitative_value = (
                [self.has_quantitative_value]
                if self.has_quantitative_value is not None
                else []
            )
        self.has_quantitative_value = [
            v if isinstance(v, QuantityValue) else QuantityValue(**as_dict(v))
            for v in self.has_quantitative_value
        ]

        if self.has_qualitative_value is not None and not isinstance(
            self.has_qualitative_value, NamedThingId
        ):
...
class OrganismTaxon(NamedThing):
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        if self.has_taxonomic_rank is not None and not isinstance(
            self.has_taxonomic_rank, TaxonomicRankId
        ):
...
class Agent(AdministrativeEntity):
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        if not isinstance(self.affiliation, list):
            self.affiliation = (
                [self.affiliation] if self.affiliation is not None else []
            )
        self.affiliation = [
            v if isinstance(v, URIorCURIE) else URIorCURIE(v) for v in self.affiliation
        ]
...
class DatasetDistribution(InformationContentEntity):
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        if self.distribution_download_url is not None and not isinstance(
            self.distribution_download_url, str
        ):
...
class DatasetVersion(InformationContentEntity):
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        if self.has_distribution is not None and not isinstance(
            self.has_distribution, DatasetDistributionId
        ):
...
class DatasetSummary(InformationContentEntity):
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        if self.source_web_page is not None and not isinstance(
            self.source_web_page, str
        ):
...
class Publication(InformationContentEntity):
    ...
    authors: Optional[Union[Union[str, AgentId], list[Union[str, AgentId]]]] = (
        empty_list()
    )
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        if not isinstance(self.publication_type, list):
            self.publication_type = (
                [self.publication_type] if self.publication_type is not None else []
            )
        self.publication_type = [
            v if isinstance(v, str) else str(v) for v in self.publication_type
        ]

        if not isinstance(self.authors, list):
            self.authors = [self.authors] if self.authors is not None else []
        self.authors = [
            v if isinstance(v, AgentId) else AgentId(v) for v in self.authors
        ]
        ...
        self.mesh_terms = [
            v if isinstance(v, URIorCURIE) else URIorCURIE(v) for v in self.mesh_terms
        ]
...
class Serial(Publication):
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        if self.iso_abbreviation is not None and not isinstance(
            self.iso_abbreviation, str
        ):
...
class RetrievalSource(InformationContentEntity):
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        if self.upstream_resource_ids is not None and not isinstance(
            self.upstream_resource_ids, URIorCURIE
        ):
...
class ThingWithTaxon(YAMLRoot):
    ...
    in_taxon: Optional[
        Union[Union[str, OrganismTaxonId], list[Union[str, OrganismTaxonId]]]
    ] = empty_list()
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        self.in_taxon = [
            v if isinstance(v, OrganismTaxonId) else OrganismTaxonId(v)
            for v in self.in_taxon
        ]

        if self.in_taxon_label is not None and not isinstance(
            self.in_taxon_label, LabelType
        ):
...
class ChemicalEntity(NamedThing):
    ...
    available_from: Optional[
        Union[
            Union[str, "DrugAvailabilityEnum"], list[Union[str, "DrugAvailabilityEnum"]]
        ]
    ] = empty_list()
    max_tolerated_dose: Optional[str] = None
    is_toxic: Optional[Union[bool, Bool]] = None
    has_chemical_role: Optional[
        Union[Union[str, ChemicalRoleId], list[Union[str, ChemicalRoleId]]]
    ] = empty_list()
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        if not isinstance(self.available_from, list):
            self.available_from = (
                [self.available_from] if self.available_from is not None else []
            )
        self.available_from = [
            v if isinstance(v, DrugAvailabilityEnum) else DrugAvailabilityEnum(v)
            for v in self.available_from
        ]

        if self.max_tolerated_dose is not None and not isinstance(
            self.max_tolerated_dose, str
        ):
        ...
        if not isinstance(self.has_chemical_role, list):
            self.has_chemical_role = (
                [self.has_chemical_role] if self.has_chemical_role is not None else []
            )
        self.has_chemical_role = [
            v if isinstance(v, ChemicalRoleId) else ChemicalRoleId(v)
            for v in self.has_chemical_role
        ]
...
class ChemicalMixture(ChemicalEntity):
    ...
    routes_of_delivery: Optional[
        Union[Union[str, "DrugDeliveryEnum"], list[Union[str, "DrugDeliveryEnum"]]]
    ] = empty_list()
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        if self.highest_FDA_approval_status is not None and not isinstance(
            ...
            self.highest_FDA_approval_status = ApprovalStatusEnum(
                self.highest_FDA_approval_status
            )
        ...
        if self.drug_regulatory_status_world_wide is not None and not isinstance(
            ...
            self.drug_regulatory_status_world_wide = ApprovalStatusEnum(
                self.drug_regulatory_status_world_wide
            )

        if not isinstance(self.routes_of_delivery, list):
            self.routes_of_delivery = (
                [self.routes_of_delivery] if self.routes_of_delivery is not None else []
            )
        self.routes_of_delivery = [
            v if isinstance(v, DrugDeliveryEnum) else DrugDeliveryEnum(v)
            for v in self.routes_of_delivery
        ]
...
class BiologicalProcessOrActivity(BiologicalEntity):
    ...
    enabled_by: Optional[
        Union[Union[str, PhysicalEntityId], list[Union[str, PhysicalEntityId]]]
    ] = empty_list()
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        self.enabled_by = [
            v if isinstance(v, PhysicalEntityId) else PhysicalEntityId(v)
...
class MolecularActivity(BiologicalProcessOrActivity):
    ...
    category: Union[Union[str, URIorCURIE], list[Union[str, URIorCURIE]]] = None
    has_input: Optional[
        Union[Union[str, MolecularEntityId], list[Union[str, MolecularEntityId]]]
    ] = empty_list()
    has_output: Optional[
        Union[Union[str, MolecularEntityId], list[Union[str, MolecularEntityId]]]
    ] = empty_list()
    enabled_by: Optional[
        Union[
            Union[dict, "MacromolecularMachineMixin"],
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        if not isinstance(self.has_input, list):
            self.has_input = [self.has_input] if self.has_input is not None else []
        self.has_input = [
            v if isinstance(v, MolecularEntityId) else MolecularEntityId(v)
            for v in self.has_input
        ]
        ...
        self.enabled_by = [
            v
            if isinstance(v, MacromolecularMachineMixin)
            else MacromolecularMachineMixin(**as_dict(v))
            for v in self.enabled_by
        ]
...
class ProteinDomain(BiologicalEntity):
    ...
    has_gene_or_gene_product: Optional[
        Union[Union[str, GeneId], list[Union[str, GeneId]]]
    ] = empty_list()
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        if not isinstance(self.has_gene_or_gene_product, list):
            self.has_gene_or_gene_product = (
                [self.has_gene_or_gene_product]
                if self.has_gene_or_gene_product is not None
                else []
            )
        self.has_gene_or_gene_product = [
            v if isinstance(v, GeneId) else GeneId(v)
            for v in self.has_gene_or_gene_product
        ]
...
class Genotype(BiologicalEntity):
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        if self.has_zygosity is not None and not isinstance(
            self.has_zygosity, ZygosityId
        ):
...
class SequenceVariant(BiologicalEntity):
    ...
    category: Union[Union[str, URIorCURIE], list[Union[str, URIorCURIE]]] = None
    has_gene: Optional[Union[Union[str, GeneId], list[Union[str, GeneId]]]] = (
        empty_list()
    )
    has_biological_sequence: Optional[Union[str, BiologicalSequence]] = None
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        self.has_gene = [
            v if isinstance(v, GeneId) else GeneId(v) for v in self.has_gene
        ]
...
class ClinicalFinding(PhenotypicFeature):
    ...
    category: Union[Union[str, URIorCURIE], list[Union[str, URIorCURIE]]] = None
    has_attribute: Optional[
        Union[Union[str, ClinicalAttributeId], list[Union[str, ClinicalAttributeId]]]
    ] = empty_list()
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        self.has_attribute = [
            v if isinstance(v, ClinicalAttributeId) else ClinicalAttributeId(v)
            for v in self.has_attribute
        ]
...
class Treatment(NamedThing):
    ...
    category: Union[Union[str, URIorCURIE], list[Union[str, URIorCURIE]]] = None
    has_drug: Optional[Union[Union[str, DrugId], list[Union[str, DrugId]]]] = (
        empty_list()
    )
    has_device: Optional[Union[Union[str, DeviceId], list[Union[str, DeviceId]]]] = (
        empty_list()
    )
    has_procedure: Optional[
        Union[Union[str, ProcedureId], list[Union[str, ProcedureId]]]
    ] = empty_list()
    timepoint: Optional[Union[str, TimeType]] = None
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        self.has_drug = [
            v if isinstance(v, DrugId) else DrugId(v) for v in self.has_drug
        ]

        if not isinstance(self.has_device, list):
            self.has_device = [self.has_device] if self.has_device is not None else []
        self.has_device = [
            v if isinstance(v, DeviceId) else DeviceId(v) for v in self.has_device
        ]

        if not isinstance(self.has_procedure, list):
            self.has_procedure = (
                [self.has_procedure] if self.has_procedure is not None else []
            )
        self.has_procedure = [
            v if isinstance(v, ProcedureId) else ProcedureId(v)
            for v in self.has_procedure
        ]
...
class SocioeconomicExposure(Attribute):
    ...
    has_attribute_type: Union[str, OntologyClassId] = None
    has_attribute: Union[
        Union[str, SocioeconomicAttributeId], list[Union[str, SocioeconomicAttributeId]]
    ] = None
    timepoint: Optional[Union[str, TimeType]] = None
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        self.has_attribute = [
            v
            if isinstance(v, SocioeconomicAttributeId)
            else SocioeconomicAttributeId(v)
            for v in self.has_attribute
        ]
...
class Association(Entity):
    ...
    has_evidence: Optional[
        Union[Union[str, EvidenceTypeId], list[Union[str, EvidenceTypeId]]]
    ] = empty_list()
    ...
    subject_category_closure: Optional[
        Union[Union[str, OntologyClassId], list[Union[str, OntologyClassId]]]
    ] = empty_list()
    object_category_closure: Optional[
        Union[Union[str, OntologyClassId], list[Union[str, OntologyClassId]]]
    ] = empty_list()
    ...
    retrieval_source_ids: Optional[
        Union[Union[str, RetrievalSourceId], list[Union[str, RetrievalSourceId]]]
    ] = empty_list()
    p_value: Optional[float] = None
    adjusted_p_value: Optional[float] = None
    has_supporting_studies: Optional[
        Union[Union[str, StudyId], list[Union[str, StudyId]]]
    ] = empty_list()
    type: Optional[Union[str, list[str]]] = empty_list()
    category: Optional[Union[Union[str, URIorCURIE], list[Union[str, URIorCURIE]]]] = (
        empty_list()
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        if not isinstance(self.publications, list):
            self.publications = (
                [self.publications] if self.publications is not None else []
            )
        self.publications = [
        ...
        if not isinstance(self.has_evidence, list):
            self.has_evidence = (
                [self.has_evidence] if self.has_evidence is not None else []
            )
        self.has_evidence = [
            v if isinstance(v, EvidenceTypeId) else EvidenceTypeId(v)
            for v in self.has_evidence
        ]

        if self.knowledge_source is not None and not isinstance(
            self.knowledge_source, str
        ):
        ...
        if not isinstance(self.aggregator_knowledge_source, list):
            self.aggregator_knowledge_source = (
                [self.aggregator_knowledge_source]
                if self.aggregator_knowledge_source is not None
                else []
            )
        self.aggregator_knowledge_source = [
            v if isinstance(v, str) else str(v)
            for v in self.aggregator_knowledge_source
        ]

        if self.timepoint is not None and not isinstance(self.timepoint, TimeType):
            self.timepoint = TimeType(self.timepoint)

        if self.original_subject is not None and not isinstance(
            self.original_subject, str
        ):
            self.original_subject = str(self.original_subject)

        if self.original_predicate is not None and not isinstance(
            self.original_predicate, URIorCURIE
        ):
            self.original_predicate = URIorCURIE(self.original_predicate)

        if self.original_object is not None and not isinstance(
            self.original_object, str
        ):
            self.original_object = str(self.original_object)

        if self.subject_category is not None and not isinstance(
            self.subject_category, OntologyClassId
        ):
        ...
        if not isinstance(self.object_closure, list):
            self.object_closure = (
                [self.object_closure] if self.object_closure is not None else []
            )
        self.object_closure = [
            v if isinstance(v, str) else str(v) for v in self.object_closure
        ]

        if not isinstance(self.subject_category_closure, list):
            self.subject_category_closure = (
                [self.subject_category_closure]
                if self.subject_category_closure is not None
                else []
            )
        self.subject_category_closure = [
            v if isinstance(v, OntologyClassId) else OntologyClassId(v)
            for v in self.subject_category_closure
        ]

        if not isinstance(self.object_category_closure, list):
            self.object_category_closure = (
                [self.object_category_closure]
                if self.object_category_closure is not None
                else []
            )
        self.object_category_closure = [
            v if isinstance(v, OntologyClassId) else OntologyClassId(v)
            for v in self.object_category_closure
        ]

        if self.subject_namespace is not None and not isinstance(
            self.subject_namespace, str
        ):
            self.subject_namespace = str(self.subject_namespace)

        if self.object_namespace is not None and not isinstance(
            self.object_namespace, str
        ):
            self.object_namespace = str(self.object_namespace)

        if not isinstance(self.subject_label_closure, list):
            self.subject_label_closure = (
                [self.subject_label_closure]
                if self.subject_label_closure is not None
                else []
            )
        self.subject_label_closure = [
            v if isinstance(v, str) else str(v) for v in self.subject_label_closure
        ]

        if not isinstance(self.object_label_closure, list):
            self.object_label_closure = (
                [self.object_label_closure]
                if self.object_label_closure is not None
                else []
            )
        self.object_label_closure = [
            v if isinstance(v, str) else str(v) for v in self.object_label_closure
        ]

        if not isinstance(self.retrieval_source_ids, list):
            self.retrieval_source_ids = (
                [self.retrieval_source_ids]
                if self.retrieval_source_ids is not None
                else []
            )
        self.retrieval_source_ids = [
            v if isinstance(v, RetrievalSourceId) else RetrievalSourceId(v)
            for v in self.retrieval_source_ids
        ]

        if self.p_value is not None and not isinstance(self.p_value, float):
            self.p_value = float(self.p_value)

        if self.adjusted_p_value is not None and not isinstance(
            self.adjusted_p_value, float
        ):
        ...
        if not isinstance(self.has_supporting_studies, list):
            self.has_supporting_studies = (
                [self.has_supporting_studies]
                if self.has_supporting_studies is not None
                else []
            )
        self.has_supporting_studies = [
            v if isinstance(v, StudyId) else StudyId(v)
            for v in self.has_supporting_studies
        ]
...
class GeneExpressionMixin(YAMLRoot):
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        if self.quantifier_qualifier is not None and not isinstance(
            self.quantifier_qualifier, OntologyClassId
        ):
            self.quantifier_qualifier = OntologyClassId(self.quantifier_qualifier)

        if self.expression_site is not None and not isinstance(
            self.expression_site, AnatomicalEntityId
        ):
            self.expression_site = AnatomicalEntityId(self.expression_site)

        if self.stage_qualifier is not None and not isinstance(
            self.stage_qualifier, LifeStageId
        ):
            self.stage_qualifier = LifeStageId(self.stage_qualifier)

        if self.phenotypic_state is not None and not isinstance(
            self.phenotypic_state, DiseaseOrPhenotypicFeatureId
        ):
...
class ReactionToParticipantAssociation(ChemicalToChemicalAssociation):
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        if self.reaction_direction is not None and not isinstance(
            self.reaction_direction, ReactionDirectionEnum
        ):
            self.reaction_direction = ReactionDirectionEnum(self.reaction_direction)

        if self.reaction_side is not None and not isinstance(
            self.reaction_side, ReactionSideEnum
        ):
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        if not isinstance(self.catalyst_qualifier, list):
            self.catalyst_qualifier = (
                [self.catalyst_qualifier] if self.catalyst_qualifier is not None else []
            )
        self.catalyst_qualifier = [
            v
            if isinstance(v, MacromolecularMachineMixin)
...
class ChemicalOrDrugOrTreatmentToDiseaseOrPhenotypicFeatureAssociation(Association):
    ...
    id: Union[
        str, ChemicalOrDrugOrTreatmentToDiseaseOrPhenotypicFeatureAssociationId
    ] = None
    subject: Union[str, NamedThingId] = None
    object: Union[str, NamedThingId] = None
    knowledge_level: Union[str, "KnowledgeLevelEnum"] = None
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        if self._is_empty(self.id):
            self.MissingRequiredField("id")
        if not isinstance(
            self.id, ChemicalOrDrugOrTreatmentToDiseaseOrPhenotypicFeatureAssociationId
        ):
            self.id = (
                ChemicalOrDrugOrTreatmentToDiseaseOrPhenotypicFeatureAssociationId(
                    self.id
        ...
        if self.FDA_adverse_event_level is not None and not isinstance(
            ...
            self.FDA_adverse_event_level = FDAIDAAdverseEventEnum(
                self.FDA_adverse_event_level
            )

        if self.frequency_qualifier is not None and not isinstance(
            self.frequency_qualifier, FrequencyValue
        ):
        ...
        if self.disease_context_qualifier is not None and not isinstance(
            self.disease_context_qualifier, DiseaseId
        ):
...
class ChemicalOrDrugOrTreatmentSideEffectDiseaseOrPhenotypicFeatureAssociation(
    ...
    id: Union[
        str, ChemicalOrDrugOrTreatmentSideEffectDiseaseOrPhenotypicFeatureAssociationId
    ] = None
    subject: Union[str, NamedThingId] = None
    object: Union[str, NamedThingId] = None
    knowledge_level: Union[str, "KnowledgeLevelEnum"] = None
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        if not isinstance(
            self.id,
            ChemicalOrDrugOrTreatmentSideEffectDiseaseOrPhenotypicFeatureAssociationId,
        ):
            self.id = ChemicalOrDrugOrTreatmentSideEffectDiseaseOrPhenotypicFeatureAssociationId(
                self.id
            )
...
class NamedThingAssociatedWithLikelihoodOfNamedThingAssociation(Association):
    ...
    population_context_qualifier: Optional[
        Union[str, PopulationOfIndividualOrganismsId]
    ] = None
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        if self._is_empty(self.id):
            self.MissingRequiredField("id")
        if not isinstance(
            self.id, NamedThingAssociatedWithLikelihoodOfNamedThingAssociationId
        ):
            self.id = NamedThingAssociatedWithLikelihoodOfNamedThingAssociationId(
                self.id
            )
        ...
        if self.subject_context_qualifier is not None and not isinstance(
            ...
            self.subject_context_qualifier = OntologyClassId(
                self.subject_context_qualifier
            )
        ...
        if self.object_context_qualifier is not None and not isinstance(
            self.object_context_qualifier, OntologyClassId
        ):
            self.object_context_qualifier = OntologyClassId(
                self.object_context_qualifier
            )
        ...
        if self.population_context_qualifier is not None and not isinstance(
            ...
            self.population_context_qualifier = PopulationOfIndividualOrganismsId(
                self.population_context_qualifier
            )
...
class ChemicalGeneInteractionAssociation(Association):
    ...
    object: Union[dict, GeneOrGeneProduct] = None
    predicate: Union[str, PredicateType] = None
    subject_form_or_variant_qualifier: Optional[
        Union[str, "ChemicalOrGeneOrGeneProductFormOrVariantEnum"]
    ] = None
    subject_part_qualifier: Optional[
        Union[str, "GeneOrGeneProductOrChemicalPartQualifierEnum"]
    ] = None
    subject_derivative_qualifier: Optional[
        Union[str, "ChemicalEntityDerivativeEnum"]
    ] = None
    subject_context_qualifier: Optional[Union[str, AnatomicalEntityId]] = None
    object_form_or_variant_qualifier: Optional[
        Union[str, "ChemicalOrGeneOrGeneProductFormOrVariantEnum"]
    ] = None
    object_part_qualifier: Optional[
        Union[str, "GeneOrGeneProductOrChemicalPartQualifierEnum"]
    ] = None
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        if self.subject_derivative_qualifier is not None and not isinstance(
            ...
            self.subject_derivative_qualifier = ChemicalEntityDerivativeEnum(
                self.subject_derivative_qualifier
            )
        ...
        if self.anatomical_context_qualifier is not None and not isinstance(
            ...
            self.anatomical_context_qualifier = AnatomicalEntityId(
                self.anatomical_context_qualifier
            )
...
class GeneRegulatesGeneAssociation(Association):
    ...
    knowledge_level: Union[str, "KnowledgeLevelEnum"] = None
    agent_type: Union[str, "AgentTypeEnum"] = None
    object_aspect_qualifier: Union[
        str, "GeneOrGeneProductOrChemicalEntityAspectEnum"
    ] = None
...
class ChemicalAffectsGeneAssociation(Association):
    ...
    subject_aspect_qualifier: Optional[
        Union[str, "GeneOrGeneProductOrChemicalEntityAspectEnum"]
    ] = None
    subject_context_qualifier: Optional[Union[str, AnatomicalEntityId]] = None
    subject_direction_qualifier: Optional[Union[str, "DirectionQualifierEnum"]] = None
    object_form_or_variant_qualifier: Optional[
    ...
    object_aspect_qualifier: Optional[
        Union[str, "GeneOrGeneProductOrChemicalEntityAspectEnum"]
    ] = None
    object_context_qualifier: Optional[Union[str, AnatomicalEntityId]] = None
    object_direction_qualifier: Optional[Union[str, "DirectionQualifierEnum"]] = None
...
class GeneAffectsChemicalAssociation(Association):
    ...
    object_context_qualifier: Optional[Union[str, AnatomicalEntityId]] = None
    object_direction_qualifier: Optional[Union[str, "DirectionQualifierEnum"]] = None
    object_derivative_qualifier: Optional[
        Union[str, "ChemicalEntityDerivativeEnum"]
    ] = None
    causal_mechanism_qualifier: Optional[Union[str, "CausalMechanismQualifierEnum"]] = (
        None
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        if self.object_derivative_qualifier is not None and not isinstance(
            ...
            self.object_derivative_qualifier = ChemicalEntityDerivativeEnum(
                self.object_derivative_qualifier
            )
...
class MaterialSampleToDiseaseOrPhenotypicFeatureAssociation(Association):
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        if self._is_empty(self.id):
            self.MissingRequiredField("id")
        if not isinstance(
            self.id, MaterialSampleToDiseaseOrPhenotypicFeatureAssociationId
        ):
...
class ExposureEventToOutcomeAssociation(Association):
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        if self.temporal_context_qualifier is not None and not isinstance(
            self.temporal_context_qualifier, TimeType
        ):
...
class EntityToPhenotypicFeatureAssociationMixin(
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        if self.sex_qualifier is not None and not isinstance(
            self.sex_qualifier, BiologicalSexId
        ):
        ...
        if self.subject_specialization_qualifier is not None and not isinstance(
            ...
            self.subject_specialization_qualifier = URIorCURIE(
                self.subject_specialization_qualifier
            )
        ...
        if self.object_specialization_qualifier is not None and not isinstance(
            ...
            self.object_specialization_qualifier = URIorCURIE(
                self.object_specialization_qualifier
            )
...
class DiseaseOrPhenotypicFeatureToGeneticInheritanceAssociation(Association):
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        if self._is_empty(self.id):
            self.MissingRequiredField("id")
        if not isinstance(
            self.id, DiseaseOrPhenotypicFeatureToGeneticInheritanceAssociationId
        ):
            self.id = DiseaseOrPhenotypicFeatureToGeneticInheritanceAssociationId(
                self.id
            )
...
class DiseaseToPhenotypicFeatureAssociation(Association):
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        if self.onset_qualifier is not None and not isinstance(
            self.onset_qualifier, OnsetId
        ):
...
class DruggableGeneToDiseaseAssociation(GeneToDiseaseAssociation):
    ...
    has_evidence: Optional[
        Union[
            Union[str, "DruggableGeneCategoryEnum"],
            list[Union[str, "DruggableGeneCategoryEnum"]],
        ]
    ] = empty_list()
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        self.has_evidence = [
            v
            if isinstance(v, DruggableGeneCategoryEnum)
            else DruggableGeneCategoryEnum(v)
            for v in self.has_evidence
        ]
...
class MacromolecularMachineToMolecularActivityAssociation(FunctionalAssociation):
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        if self._is_empty(self.id):
            self.MissingRequiredField("id")
        if not isinstance(
            self.id, MacromolecularMachineToMolecularActivityAssociationId
        ):
...
class MacromolecularMachineToBiologicalProcessAssociation(FunctionalAssociation):
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        if self._is_empty(self.id):
            self.MissingRequiredField("id")
        if not isinstance(
            self.id, MacromolecularMachineToBiologicalProcessAssociationId
        ):
...
class MacromolecularMachineToCellularComponentAssociation(FunctionalAssociation):
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        if self._is_empty(self.id):
            self.MissingRequiredField("id")
        if not isinstance(
            self.id, MacromolecularMachineToCellularComponentAssociationId
        ):
...
class EntityToDiseaseAssociation(Association):
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        if self.clinical_approval_status is not None and not isinstance(
            ...
            self.clinical_approval_status = ClinicalApprovalStatusEnum(
                self.clinical_approval_status
            )

        if self.max_research_phase is not None and not isinstance(
            self.max_research_phase, ResearchPhaseEnum
        ):
...
class GenomicSequenceLocalization(SequenceAssociation):
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        if self.start_interbase_coordinate is not None and not isinstance(
            self.start_interbase_coordinate, int
        ):
            self.start_interbase_coordinate = int(self.start_interbase_coordinate)

        if self.end_interbase_coordinate is not None and not isinstance(
            self.end_interbase_coordinate, int
        ):
            self.end_interbase_coordinate = int(self.end_interbase_coordinate)

        if self.genome_build is not None and not isinstance(
            self.genome_build, StrandEnum
        ):
...
class ChemicalEntityOrGeneOrGeneProductRegulatesGeneAssociation(Association):
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        if self._is_empty(self.id):
            self.MissingRequiredField("id")
        if not isinstance(
            self.id, ChemicalEntityOrGeneOrGeneProductRegulatesGeneAssociationId
        ):
            self.id = ChemicalEntityOrGeneOrGeneProductRegulatesGeneAssociationId(
                self.id
            )
...
class OrganismTaxonToOrganismTaxonInteraction(OrganismTaxonToOrganismTaxonAssociation):
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        if self.associated_environmental_context is not None and not isinstance(
            ...
            self.associated_environmental_context = str(
                self.associated_environmental_context
            )
...
class ApprovalStatusEnum(EnumDefinitionImpl):
    ...
    fda_review_phase_4 = PermissibleValue(
        text="fda_review_phase_4", description="FDA Review"
    )
...
class ChemicalOrGeneOrGeneProductFormOrVariantEnum(EnumDefinitionImpl):
    ...
    loss_of_function_variant_form = PermissibleValue(
        text="loss_of_function_variant_form"
    )
    gain_of_function_variant_form = PermissibleValue(
...
class DrugAvailabilityEnum(EnumDefinitionImpl):
    ...
    prescription = PermissibleValue(
        text="prescription", description="chemical entity is available by prescription."
    )
...
slots.url = Slot(
    uri=BIOLINK.url,
    name="url",
    curie=BIOLINK.curie("url"),
    model_uri=BIOLINK.url,
    domain=Entity,
    range=Optional[str],
)
...
slots.animal_model_available_from = Slot(
    ...
    range=Optional[
        Union[
            Union[str, DiseaseOrPhenotypicFeatureId],
            list[Union[str, DiseaseOrPhenotypicFeatureId]],
        ]
    ],
)
...
slots.active_in = Slot(
    ...
    domain=None,
    range=Optional[
        Union[Union[str, CellularComponentId], list[Union[str, CellularComponentId]]]
    ],
)
...
slots.has_active_component = Slot(
    ...
    range=Optional[
        Union[Union[dict, "GeneOrGeneProduct"], list[Union[dict, "GeneOrGeneProduct"]]]
    ],
)
...
slots.acts_upstream_of = Slot(
    ...
    domain=None,
    range=Optional[
        Union[Union[str, BiologicalProcessId], list[Union[str, BiologicalProcessId]]]
    ],
)
...
slots.contributor = Slot(
    ...
    range=Optional[
        Union[
            Union[str, InformationContentEntityId],
            list[Union[str, InformationContentEntityId]],
        ]
    ],
)
...
slots.associated_with_sensitivity_to = Slot(
    ...
    domain=NamedThing,
    range=Optional[
        Union[Union[str, ChemicalEntityId], list[Union[str, ChemicalEntityId]]]
    ],
)
...
slots.is_diagnosed_by = Slot(
    ...
    range=Optional[
        Union[Union[str, DiagnosticAidId], list[Union[str, DiagnosticAidId]]]
    ],
)
...
slots.affects_response_to = Slot(
    ...
    range=Optional[
        Union[
            Union[dict, "ChemicalEntityOrGeneOrGeneProduct"],
            list[Union[dict, "ChemicalEntityOrGeneOrGeneProduct"]],
        ]
    ],
)
...
slots.regulates = Slot(
    ...
    range=Optional[
        Union[
            Union[dict, "PhysicalEssenceOrOccurrent"],
            list[Union[dict, "PhysicalEssenceOrOccurrent"]],
        ]
    ],
)
...
slots.has_gene_product = Slot(
    ...
    domain=Gene,
    range=Optional[
        Union[Union[dict, "GeneProductMixin"], list[Union[dict, "GeneProductMixin"]]]
    ],
)
...
slots.condition_ameliorated_by = Slot(
    ...
    range=Optional[
        Union[
            Union[dict, ChemicalOrDrugOrTreatment],
            list[Union[dict, ChemicalOrDrugOrTreatment]],
        ]
    ],
)
...
slots.expressed_in = Slot(
    ...
    domain=None,
    range=Optional[
        Union[Union[str, AnatomicalEntityId], list[Union[str, AnatomicalEntityId]]]
    ],
)
...
slots.has_phenotype = Slot(
    ...
    range=Optional[
        Union[Union[str, PhenotypicFeatureId], list[Union[str, PhenotypicFeatureId]]]
    ],
)
...
slots.phenotype_of = Slot(
    ...
    range=Optional[
        Union[Union[str, BiologicalEntityId], list[Union[str, BiologicalEntityId]]]
    ],
)
...
slots.has_sequence_location = Slot(
    ...
    domain=NucleicAcidEntity,
    range=Optional[
        Union[Union[str, NucleicAcidEntityId], list[Union[str, NucleicAcidEntityId]]]
    ],
)
...
slots.is_input_of = Slot(
    ...
    range=Optional[
        Union[
            Union[str, BiologicalProcessOrActivityId],
            list[Union[str, BiologicalProcessOrActivityId]],
        ]
    ],
)
...
slots.has_mode_of_inheritance = Slot(
    ...
    domain=DiseaseOrPhenotypicFeature,
    range=Optional[
        Union[Union[str, GeneticInheritanceId], list[Union[str, GeneticInheritanceId]]]
    ],
)
...
slots.has_sequence_variant = Slot(
    ...
    domain=None,
    range=Optional[
        Union[Union[str, SequenceVariantId], list[Union[str, SequenceVariantId]]]
    ],
)
...
slots.taxon_of = Slot(
    ...
    range=Optional[
        Union[Union[dict, "ThingWithTaxon"], list[Union[dict, "ThingWithTaxon"]]]
    ],
)
