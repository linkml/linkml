...
class BiolinkNameSpace:
    ...
    _namespaces = [
        ...
        CurieNamespace('KEGG', 'http://www.kegg.jp/entry/'),
        CurieNamespace('KEGG_BRITE', 'https://bioregistry.io/kegg.brite:'),
        ...
        CurieNamespace('KEGG_GENES', 'https://bioregistry.io/kegg.genes:bsu:'),
        ...
        CurieNamespace('KEGG_PATHWAY', 'https://bioregistry.io/kegg.pathway:'),
        CurieNamespace('KEGG_RCLASS', 'https://www.genome.jp/dbget-bin/www_bget?rc:'),
        ...
        CurieNamespace('PHARMGKB_DISEASE', 'https://www.pharmgkb.org/disease/'),
        CurieNamespace('PHARMGKB_DRUG', 'https://www.pharmgkb.org/chemical/'),
        CurieNamespace('PHARMGKB_GENE', 'https://www.pharmgkb.org/gene/'),
        CurieNamespace('PHARMGKB_PATHWAYS', 'https://www.pharmgkb.org/pathway/'),
        CurieNamespace('PHARMGKB_VARIANT', 'https://www.pharmgkb.org/variant/'),
        CurieNamespace('PHAROS', 'http://pharos.nih.gov'),
        CurieNamespace('PIRSF', 'http://identifiers.org/pirsf/'),
        CurieNamespace('PMC', 'http://europepmc.org/articles/PMC'),
        CurieNamespace('PMCID', 'http://www.ncbi.nlm.nih.gov/pmc/'),
        ...
        CurieNamespace('WBls', 'http://purl.obolibrary.org/obo/WBls_'),
        CurieNamespace('WIKIDATA', 'https://www.wikidata.org/entity/'),
        CurieNamespace('WIKIDATA_PROPERTY', 'https://www.wikidata.org/prop/'),
