...
def metamodel_module():
    """The metamodel generated by pydanticgen with the canonical vendoring options."""
    source = PydanticGenerator(LOCAL_METAMODEL_YAML_FILE, **_generation_script_kwargs()).serialize()
