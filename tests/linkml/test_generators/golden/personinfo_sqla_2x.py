...
class HasAliases(Base):
    ...
    aliases: AssociationProxy[list[str]] = association_proxy(
        "aliases_rel",
        "alias",
...
class Person(NamedThing):
    ...
    gender: Mapped[str | None] = mapped_column(Enum('nonbinary man', 'nonbinary woman', 'transgender woman', 'transgender man', 'cisgender man', 'cisgender woman', name='GenderType'))
    ...
    depicted_by: Mapped[str | None] = mapped_column(Text())
    Container_id: Mapped[int | None] = mapped_column(Integer(), ForeignKey("Container.id"))
    current_address_id: Mapped[int | None] = mapped_column(Integer(), ForeignKey("Address.id"))
    current_address: Mapped[Address | None] = relationship(foreign_keys=[current_address_id])
...
class MedicalEvent(Event):
    ...
    is_current: Mapped[bool | None] = mapped_column(Boolean())
    Person_id: Mapped[str | None] = mapped_column(Text(), ForeignKey("Person.id"))
    diagnosis_id: Mapped[str | None] = mapped_column(Text(), ForeignKey("DiagnosisConcept.id"))
