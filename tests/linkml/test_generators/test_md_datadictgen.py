...
def test_connected_components_detection(input_path):
    ...
    assert inheritance_component in component_sets, (
        f"Inheritance component {inheritance_component} not found in {component_sets}"
    )
    ...
    assert truly_standalone_classes == expected_standalone_classes, (
        f"Expected standalone classes {expected_standalone_classes}, got {truly_standalone_classes}"
    )
