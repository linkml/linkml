...
class Colors(EnumDefinitionImpl):
    ...
    def _addvals(cls):
        setattr(
            cls,
            "1",
            PermissibleValue(text="1", description="Red", meaning=SCT["371240000"]),
        )
        setattr(
            cls,
            "2",
            PermissibleValue(text="2", description="Yellow", meaning=SCT["371244009"]),
        )
        setattr(cls, "3", PermissibleValue(text="3", meaning=SCT["405738005"]))
        setattr(
            cls,
            "4",
            PermissibleValue(text="4", description="Muted", meaning=SCT["abcde"]),
        )
