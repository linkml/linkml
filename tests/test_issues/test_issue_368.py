    ...
    def test_issue_368(self):
        ...
        env.generate_single_file(
            ...
            lambda: PythonGenerator(
                env.input_path("issue_368_imports.yaml"), mergeimports=False
            ).serialize(),
        ...
        env.generate_single_file(
            "issue_368.py",
            lambda: PythonGenerator(
                env.input_path("issue_368.yaml"), mergeimports=False
            ).serialize(),
            comparator=lambda exp, act: compare_python(
        ...
        env.generate_single_file(
            ...
            lambda: ContextGenerator(
                env.input_path("issue_368.yaml"), emit_metadata=False
            ).serialize(),
