...
from tests.test_compliance.test_compliance import CLASS_C, CORE_FRAMEWORKS, SLOT_S1, ENUM_E, EXAMPLE_NS
...
@pytest.mark.parametrize("enum_name,enums,data_name,data,is_valid", [
    ("defaults_to_class",
     {
         ENUM_E: {
                "permissible_values": {
