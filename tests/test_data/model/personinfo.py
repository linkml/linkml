...
class GenderType(EnumDefinitionImpl):
    ...
    transgender_woman = PermissibleValue(text="transgender_woman", meaning=GSSO["000384"])
...
slots.places = Slot(
    ...
    domain=None,
    range=Optional[Union[Dict[Union[str, PlaceId], Union[dict, Place]], List[Union[dict, Place]]]],
)
