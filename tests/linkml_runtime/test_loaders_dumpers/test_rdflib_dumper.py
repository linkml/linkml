...
from tests.linkml_runtime.test_loaders_dumpers.models.node_object import (
    NodeObject,
    Triple,
)
...
from tests.linkml_runtime.test_loaders_dumpers.models.personinfo_test_issue_429 import (
