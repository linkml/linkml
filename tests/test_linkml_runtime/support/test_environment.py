...
from test_linkml_runtime.support.dirutils import are_dir_trees_equal
from test_linkml_runtime.support.mismatchlog import MismatchLog


def no_click_exit(_self, code=0):
    from test_linkml_runtime import CLIExitException
