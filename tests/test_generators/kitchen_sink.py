...
# Generation date: 2021-06-25 18:13
# Schema: kitchen_sink
#
...
class Person(YAMLRoot):
    ...
    class_class_uri: ClassVar[URIRef] = GOCAM.Person
    class_class_curie: ClassVar[str] = "gocam:Person"
    class_name: ClassVar[str] = "Person"
    class_model_uri: ClassVar[URIRef] = GOCAM.Person
...
class Dataset(YAMLRoot):
    ...
    class_class_uri: ClassVar[URIRef] = GOCAM.Dataset
    class_class_curie: ClassVar[str] = "gocam:Dataset"
    class_name: ClassVar[str] = "Dataset"
    class_model_uri: ClassVar[URIRef] = GOCAM.Dataset
...
class Agent(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = GOCAM.Agent
...
slots.name = Slot(uri=CORE.name, name="name", curie=CORE.curie('name'),
                   model_uri=GOCAM.name, domain=None, range=Optional[str])

slots.description = Slot(uri=CORE.description, name="description", curie=CORE.curie('description'),
                   model_uri=GOCAM.description, domain=None, range=Optional[str])

slots.started_at_time = Slot(uri=PROV.startedAtTime, name="started at time", curie=PROV.curie('startedAtTime'),
                   model_uri=GOCAM.started_at_time, domain=None, range=Optional[str])

slots.ended_at_time = Slot(uri=PROV.endedAtTime, name="ended at time", curie=PROV.curie('endedAtTime'),
                   model_uri=GOCAM.ended_at_time, domain=None, range=Optional[str])

slots.was_informed_by = Slot(uri=PROV.wasInformedBy, name="was informed by", curie=PROV.curie('wasInformedBy'),
                   model_uri=GOCAM.was_informed_by, domain=None, range=Optional[Union[str, ActivityId]])

slots.was_associated_with = Slot(uri=PROV.wasAssociatedWith, name="was associated with", curie=PROV.curie('wasAssociatedWith'),
                   model_uri=GOCAM.was_associated_with, domain=None, range=Optional[Union[str, AgentId]])

slots.acted_on_behalf_of = Slot(uri=PROV.actedOnBehalfOf, name="acted on behalf of", curie=PROV.curie('actedOnBehalfOf'),
                   model_uri=GOCAM.acted_on_behalf_of, domain=None, range=Optional[Union[str, AgentId]])

slots.was_generated_by = Slot(uri=PROV.wasGeneratedBy, name="was generated by", curie=PROV.curie('wasGeneratedBy'),
                   model_uri=GOCAM.was_generated_by, domain=None, range=Optional[Union[str, ActivityId]])

slots.used = Slot(uri=PROV.used, name="used", curie=PROV.curie('used'),
                   model_uri=GOCAM.used, domain=Activity, range=Optional[str])

slots.activity_set = Slot(uri=CORE.activity_set, name="activity set", curie=CORE.curie('activity_set'),
                   model_uri=GOCAM.activity_set, domain=None, range=Optional[Union[Dict[Union[str, ActivityId], Union[dict, Activity]], List[Union[dict, Activity]]]])

slots.agent_set = Slot(uri=CORE.agent_set, name="agent set", curie=CORE.curie('agent_set'),
                   model_uri=GOCAM.agent_set, domain=None, range=Optional[Union[Dict[Union[str, AgentId], Union[dict, Agent]], List[Union[dict, Agent]]]])

slots.dataset__persons = Slot(uri=GOCAM.persons, name="dataset__persons", curie=GOCAM.curie('persons'),
                   model_uri=GOCAM.dataset__persons, domain=None, range=Optional[Union[Dict[Union[str, PersonId], Union[dict, Person]], List[Union[dict, Person]]]])