...
EXPECTED_any_of = [
    ...
    (
        ...
        [(rdflib.term.URIRef('http://www.w3.org/ns/shacl#datatype'),rdflib.term.URIRef('http://www.w3.org/2001/XMLSchema#integer')),
          (rdflib.term.URIRef('http://www.w3.org/ns/shacl#class'),
          rdflib.term.URIRef('https://w3id.org/linkml/tests/kitchen_sink/Person')),
         (rdflib.term.URIRef('http://www.w3.org/1999/02/22-rdf-syntax-ns#first'),
          rdflib.term.URIRef('https://example.org/bizcodes/001')),
...
def assert_any_of(expected: List[Tuple[rdflib.term.URIRef, List[Tuple[rdflib.term.URIRef, rdflib.term.URIRef]]]],
                  triples: List) -> None:
    for ex in expected:
        found = False
        for property_triple in triples:
            # look for "property" triplet
            if property_triple[0] == ex[0] and \
                    property_triple[1] == rdflib.term.URIRef('http://www.w3.org/ns/shacl#property'):
                # look for "or" triplet
