...
[![img](https://yuml.me/diagram/nofunky;dir:TB/class/[OrganismalEntity],[OrganismTaxon],[GeneToExpressionSiteAssociation]-%20stage%20qualifier%200..1>[LifeStage&#124;provided_by(i):string%20*;xref(i):uriorcurie%20*;category(i):category_type%20%2B;id(i):string;iri(i):iri_type%20%3F;type(i):string%20%3F;name(i):label_type%20%3F;description(i):narrative_text%20%3F],[GeneExpressionMixin]-%20stage%20qualifier%200..1>[LifeStage],[GeneToExpressionSiteAssociation]-%20stage%20qualifier(i)%200..1>[LifeStage],[OrganismalEntity]^-[LifeStage],[GeneToExpressionSiteAssociation],[GeneExpressionMixin],[Attribute],[Association])](https://yuml.me/diagram/nofunky;dir:TB/class/[OrganismalEntity],[OrganismTaxon],[GeneToExpressionSiteAssociation]-%20stage%20qualifier%200..1>[LifeStage&#124;provided_by(i):string%20*;xref(i):uriorcurie%20*;category(i):category_type%20%2B;id(i):string;iri(i):iri_type%20%3F;type(i):string%20%3F;name(i):label_type%20%3F;description(i):narrative_text%20%3F],[GeneExpressionMixin]-%20stage%20qualifier%200..1>[LifeStage],[GeneToExpressionSiteAssociation]-%20stage%20qualifier(i)%200..1>[LifeStage],[OrganismalEntity]^-[LifeStage],[GeneToExpressionSiteAssociation],[GeneExpressionMixin],[Attribute],[Association])
