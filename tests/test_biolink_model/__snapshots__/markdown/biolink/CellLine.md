...
[![img](https://yuml.me/diagram/nofunky;dir:TB/class/[SubjectOfInvestigation],[OrganismalEntity],[OrganismTaxon],[CellLineToEntityAssociationMixin],[CellLineAsAModelOfDiseaseAssociation],[CellLineAsAModelOfDiseaseAssociation]-%20subject%201..1>[CellLine&#124;provided_by(i):string%20*;xref(i):uriorcurie%20*;category(i):category_type%20%2B;id(i):string;iri(i):iri_type%20%3F;type(i):string%20%3F;name(i):label_type%20%3F;description(i):narrative_text%20%3F],[CellLineToEntityAssociationMixin]-%20subject%201..1>[CellLine],[CellLine]uses%20-.->[SubjectOfInvestigation],[OrganismalEntity]^-[CellLine],[Attribute])](https://yuml.me/diagram/nofunky;dir:TB/class/[SubjectOfInvestigation],[OrganismalEntity],[OrganismTaxon],[CellLineToEntityAssociationMixin],[CellLineAsAModelOfDiseaseAssociation],[CellLineAsAModelOfDiseaseAssociation]-%20subject%201..1>[CellLine&#124;provided_by(i):string%20*;xref(i):uriorcurie%20*;category(i):category_type%20%2B;id(i):string;iri(i):iri_type%20%3F;type(i):string%20%3F;name(i):label_type%20%3F;description(i):narrative_text%20%3F],[CellLineToEntityAssociationMixin]-%20subject%201..1>[CellLine],[CellLine]uses%20-.->[SubjectOfInvestigation],[OrganismalEntity]^-[CellLine],[Attribute])
