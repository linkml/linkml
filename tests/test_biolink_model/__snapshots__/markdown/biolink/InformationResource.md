...
[![img](https://yuml.me/diagram/nofunky;dir:TB/class/[Association]-%20aggregator%20knowledge%20source%200..*>[InformationResource&#124;license(i):string%20%3F;rights(i):string%20%3F;format(i):string%20%3F;creation_date(i):date%20%3F;provided_by(i):string%20*;xref(i):uriorcurie%20*;category(i):category_type%20%2B;id(i):string;iri(i):iri_type%20%3F;type(i):string%20%3F;name(i):label_type%20%3F;description(i):narrative_text%20%3F],[Association]-%20knowledge%20source%200..1>[InformationResource],[Association]-%20primary%20knowledge%20source%200..1>[InformationResource],[InformationContentEntity]^-[InformationResource],[InformationContentEntity],[Attribute],[Association])](https://yuml.me/diagram/nofunky;dir:TB/class/[Association]-%20aggregator%20knowledge%20source%200..*>[InformationResource&#124;license(i):string%20%3F;rights(i):string%20%3F;format(i):string%20%3F;creation_date(i):date%20%3F;provided_by(i):string%20*;xref(i):uriorcurie%20*;category(i):category_type%20%2B;id(i):string;iri(i):iri_type%20%3F;type(i):string%20%3F;name(i):label_type%20%3F;description(i):narrative_text%20%3F],[Association]-%20knowledge%20source%200..1>[InformationResource],[Association]-%20primary%20knowledge%20source%200..1>[InformationResource],[InformationContentEntity]^-[InformationResource],[InformationContentEntity],[Attribute],[Association])
