...
# Class: disease or phenotypic feature to genetic inheritance association
...
[![img](https://yuml.me/diagram/nofunky;dir:TB/class/[Publication],[OntologyClass],[NamedThing],[InformationResource],[GeneticInheritance],[EvidenceType],[GeneticInheritance]<object%201..1-%20[DiseaseOrPhenotypicFeatureToGeneticInheritanceAssociation&#124;predicate:predicate_type;negated(i):boolean%20%3F;timepoint(i):time_type%20%3F;original_subject(i):string%20%3F;original_predicate(i):uriorcurie%20%3F;original_object(i):string%20%3F;type(i):string%20%3F;category(i):category_type%20*;id(i):string;iri(i):iri_type%20%3F;name(i):label_type%20%3F;description(i):narrative_text%20%3F],[DiseaseOrPhenotypicFeatureToGeneticInheritanceAssociation]uses%20-.->[DiseaseOrPhenotypicFeatureToEntityAssociationMixin],[Association]^-[DiseaseOrPhenotypicFeatureToGeneticInheritanceAssociation],[DiseaseOrPhenotypicFeatureToEntityAssociationMixin],[Attribute],[Association])](https://yuml.me/diagram/nofunky;dir:TB/class/[Publication],[OntologyClass],[NamedThing],[InformationResource],[GeneticInheritance],[EvidenceType],[GeneticInheritance]<object%201..1-%20[DiseaseOrPhenotypicFeatureToGeneticInheritanceAssociation&#124;predicate:predicate_type;negated(i):boolean%20%3F;timepoint(i):time_type%20%3F;original_subject(i):string%20%3F;original_predicate(i):uriorcurie%20%3F;original_object(i):string%20%3F;type(i):string%20%3F;category(i):category_type%20*;id(i):string;iri(i):iri_type%20%3F;name(i):label_type%20%3F;description(i):narrative_text%20%3F],[DiseaseOrPhenotypicFeatureToGeneticInheritanceAssociation]uses%20-.->[DiseaseOrPhenotypicFeatureToEntityAssociationMixin],[Association]^-[DiseaseOrPhenotypicFeatureToGeneticInheritanceAssociation],[DiseaseOrPhenotypicFeatureToEntityAssociationMixin],[Attribute],[Association])
 ...
 * [disease or phenotypic feature to genetic inheritance association➞predicate](disease_or_phenotypic_feature_to_genetic_inheritance_association_predicate.md)  <sub>1..1</sub>
     * Description: A high-level grouping for the relationship type. AKA minimal predicate. This is analogous to category for nodes.
     * Range: [PredicateType](types/PredicateType.md)
 * [disease or phenotypic feature to genetic inheritance association➞object](disease_or_phenotypic_feature_to_genetic_inheritance_association_object.md)  <sub>1..1</sub>
     ...
     * Example: HP:0001417 X-linked inheritance
