...
[![img](https://yuml.me/diagram/nofunky;dir:TB/class/[QuantityValue],[OntologyClass],[NamedThing],[ChemicalEntity]-%20has%20chemical%20role%200..*>[ChemicalRole&#124;name(i):label_type%20%3F;provided_by(i):string%20*;xref(i):uriorcurie%20*;category(i):category_type%20%2B;id(i):string;iri(i):iri_type%20%3F;type(i):string%20%3F;description(i):narrative_text%20%3F],[Attribute]^-[ChemicalRole],[ChemicalEntity],[Attribute])](https://yuml.me/diagram/nofunky;dir:TB/class/[QuantityValue],[OntologyClass],[NamedThing],[ChemicalEntity]-%20has%20chemical%20role%200..*>[ChemicalRole&#124;name(i):label_type%20%3F;provided_by(i):string%20*;xref(i):uriorcurie%20*;category(i):category_type%20%2B;id(i):string;iri(i):iri_type%20%3F;type(i):string%20%3F;description(i):narrative_text%20%3F],[Attribute]^-[ChemicalRole],[ChemicalEntity],[Attribute])
