...
[![img](https://yuml.me/diagram/nofunky;dir:TB/class/[QuantityValue],[OntologyClass],[EntityToFeatureOrDiseaseQualifiersMixin]-%20onset%20qualifier%200..1>[Onset&#124;name(i):label_type%20%3F;provided_by(i):string%20*;xref(i):uriorcurie%20*;category(i):category_type%20%2B;id(i):string;iri(i):iri_type%20%3F;type(i):string%20%3F;description(i):narrative_text%20%3F],[ClinicalCourse]^-[Onset],[NamedThing],[EntityToFeatureOrDiseaseQualifiersMixin],[ClinicalCourse],[Attribute],[Association])](https://yuml.me/diagram/nofunky;dir:TB/class/[QuantityValue],[OntologyClass],[EntityToFeatureOrDiseaseQualifiersMixin]-%20onset%20qualifier%200..1>[Onset&#124;name(i):label_type%20%3F;provided_by(i):string%20*;xref(i):uriorcurie%20*;category(i):category_type%20%2B;id(i):string;iri(i):iri_type%20%3F;type(i):string%20%3F;description(i):narrative_text%20%3F],[ClinicalCourse]^-[Onset],[NamedThing],[EntityToFeatureOrDiseaseQualifiersMixin],[ClinicalCourse],[Attribute],[Association])
