...
[![img](https://yuml.me/diagram/nofunky;dir:TB/class/[ProteinDomain&#124;provided_by(i):string%20*;xref(i):uriorcurie%20*;category(i):category_type%20%2B;id(i):string;iri(i):iri_type%20%3F;type(i):string%20%3F;name(i):label_type%20%3F;description(i):narrative_text%20%3F]uses%20-.->[GeneGroupingMixin],[ProteinDomain]uses%20-.->[ChemicalEntityOrGeneOrGeneProduct],[BiologicalEntity]^-[ProteinDomain],[OrganismTaxon],[GeneGroupingMixin],[Gene],[ChemicalEntityOrGeneOrGeneProduct],[BiologicalEntity],[Attribute])](https://yuml.me/diagram/nofunky;dir:TB/class/[ProteinDomain&#124;provided_by(i):string%20*;xref(i):uriorcurie%20*;category(i):category_type%20%2B;id(i):string;iri(i):iri_type%20%3F;type(i):string%20%3F;name(i):label_type%20%3F;description(i):narrative_text%20%3F]uses%20-.->[GeneGroupingMixin],[ProteinDomain]uses%20-.->[ChemicalEntityOrGeneOrGeneProduct],[BiologicalEntity]^-[ProteinDomain],[OrganismTaxon],[GeneGroupingMixin],[Gene],[ChemicalEntityOrGeneOrGeneProduct],[BiologicalEntity],[Attribute])
