...
[![img](https://yuml.me/diagram/nofunky;dir:TB/class/[Treatment],[Treatment]<object%201..1-%20[SequenceVariantModulatesTreatmentAssociation&#124;predicate(i):predicate_type;negated(i):boolean%20%3F;timepoint(i):time_type%20%3F;original_subject(i):string%20%3F;original_predicate(i):uriorcurie%20%3F;original_object(i):string%20%3F;type(i):string%20%3F;category(i):category_type%20*;id(i):string;iri(i):iri_type%20%3F;name(i):label_type%20%3F;description(i):narrative_text%20%3F],[SequenceVariant]<subject%201..1-%20[SequenceVariantModulatesTreatmentAssociation],[Association]^-[SequenceVariantModulatesTreatmentAssociation],[SequenceVariant],[Publication],[OntologyClass],[InformationResource],[EvidenceType],[Attribute],[Association])](https://yuml.me/diagram/nofunky;dir:TB/class/[Treatment],[Treatment]<object%201..1-%20[SequenceVariantModulatesTreatmentAssociation&#124;predicate(i):predicate_type;negated(i):boolean%20%3F;timepoint(i):time_type%20%3F;original_subject(i):string%20%3F;original_predicate(i):uriorcurie%20%3F;original_object(i):string%20%3F;type(i):string%20%3F;category(i):category_type%20*;id(i):string;iri(i):iri_type%20%3F;name(i):label_type%20%3F;description(i):narrative_text%20%3F],[SequenceVariant]<subject%201..1-%20[SequenceVariantModulatesTreatmentAssociation],[Association]^-[SequenceVariantModulatesTreatmentAssociation],[SequenceVariant],[Publication],[OntologyClass],[InformationResource],[EvidenceType],[Attribute],[Association])
