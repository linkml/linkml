...
LISTS_AND_KEYS = CurieNamespace(
    "lists_and_keys", "http://examples.org/linkml/test/lists_and_keys"
)
...
class OptionalOneElementRangeList(YAMLRoot):
    ...
    v1: Optional[
        Union[Union[dict, OneElementClass], list[Union[dict, OneElementClass]]]
    ] = empty_list()
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        self.v1 = [
            v if isinstance(v, OneElementClass) else OneElementClass(**as_dict(v))
            for v in self.v1
        ]
...
class RequiredTwoElementRangeList(YAMLRoot):
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        if not isinstance(self.v1, list):
            self.v1 = [self.v1] if self.v1 is not None else []
        self.v1 = [
            v if isinstance(v, TwoElementClass) else TwoElementClass(**as_dict(v))
            for v in self.v1
        ]
...
class RequiredThreeElementRangeList(YAMLRoot):
    ...
    v1: Union[Union[dict, ThreeElementClass], list[Union[dict, ThreeElementClass]]] = (
        None
    )
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        if not isinstance(self.v1, list):
            self.v1 = [self.v1] if self.v1 is not None else []
        self.v1 = [
            v if isinstance(v, ThreeElementClass) else ThreeElementClass(**as_dict(v))
            for v in self.v1
        ]
...
class OptionalKeyedOneElementRangeList(YAMLRoot):
    ...
    class_class_uri: ClassVar[URIRef] = LISTS_AND_KEYS[
    ...
    v1: Optional[
        Union[
            Union[str, KeyedOneElementClassName],
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        self.v1 = [
            v
            if isinstance(v, KeyedOneElementClassName)
            else KeyedOneElementClassName(v)
            for v in self.v1
        ]
...
class OptionalIdentifiedOneElementRange(YAMLRoot):
    ...
    class_class_curie: ClassVar[str] = (
        "lists_and_keys:OptionalIdentifiedOneElementRange"
    )
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        if self.v1 is not None and not isinstance(
            self.v1, IdentifiedOneElementClassName
        ):
...
class OptionalIdentifiedOneElementRangeList(YAMLRoot):
    ...
    class_class_curie: ClassVar[str] = (
        "lists_and_keys:OptionalIdentifiedOneElementRangeList"
    )
    ...
    v1: Optional[
        Union[
            Union[str, IdentifiedOneElementClassName],
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        self.v1 = [
            v
            if isinstance(v, IdentifiedOneElementClassName)
            else IdentifiedOneElementClassName(v)
            for v in self.v1
        ]
...
class OptionalKeyedTwoElementRangeList(YAMLRoot):
    ...
    v1: Optional[
        Union[
            Union[str, KeyedTwoElementClassName],
            list[Union[str, KeyedTwoElementClassName]],
        ]
    ] = empty_list()
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        self.v1 = [
            v
            if isinstance(v, KeyedTwoElementClassName)
            else KeyedTwoElementClassName(v)
            for v in self.v1
        ]
...
class OptionalKeyedThreeElementRangeList(YAMLRoot):
    ...
    class_class_curie: ClassVar[str] = (
        "lists_and_keys:OptionalKeyedThreeElementRangeList"
    )
    ...
    v1: Optional[
        Union[
            Union[str, KeyedThreeElementClassName],
            list[Union[str, KeyedThreeElementClassName]],
        ]
    ] = empty_list()
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        self.v1 = [
            v
            if isinstance(v, KeyedThreeElementClassName)
            else KeyedThreeElementClassName(v)
            for v in self.v1
        ]
...
class RequiredIdentifiedThreeElementRange(YAMLRoot):
    ...
    class_class_curie: ClassVar[str] = (
        "lists_and_keys:RequiredIdentifiedThreeElementRange"
    )
...
class RequiredIdentifiedThreeElementRangeList(YAMLRoot):
    ...
    class_class_curie: ClassVar[str] = (
        "lists_and_keys:RequiredIdentifiedThreeElementRangeList"
    )
    ...
    v1: Union[
        Union[str, IdentifiedThreeElementClassName],
        list[Union[str, IdentifiedThreeElementClassName]],
    ] = None
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        self.v1 = [
            v
            if isinstance(v, IdentifiedThreeElementClassName)
            else IdentifiedThreeElementClassName(v)
            for v in self.v1
        ]
...
class RequiredKeyedThreeElementRangeList(YAMLRoot):
    ...
    class_class_curie: ClassVar[str] = (
        "lists_and_keys:RequiredKeyedThreeElementRangeList"
    )
...
class RequiredInlinedOneElementRangeList(RequiredOneElementRangeList):
    ...
    class_class_curie: ClassVar[str] = (
        "lists_and_keys:RequiredInlinedOneElementRangeList"
    )
...
class RequiredInlinedTwoElementRangeList(RequiredTwoElementRangeList):
    ...
    class_class_curie: ClassVar[str] = (
        "lists_and_keys:RequiredInlinedTwoElementRangeList"
    )
...
class RequiredInlinedThreeElementRangeList(RequiredThreeElementRangeList):
    ...
    class_class_curie: ClassVar[str] = (
        "lists_and_keys:RequiredInlinedThreeElementRangeList"
    )
...
class RequiredInlinedKeyedOneElementRange(OptionalKeyedOneElementRange):
    ...
    class_class_curie: ClassVar[str] = (
        "lists_and_keys:RequiredInlinedKeyedOneElementRange"
    )
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        self._normalize_inlined_as_dict(
            slot_name="v1", slot_type=KeyedOneElementClass, key_name="name", keyed=True
        )
...
class RequiredInlinedKeyedOneElementRangeList(OptionalKeyedOneElementRangeList):
    ...
    class_class_curie: ClassVar[str] = (
        "lists_and_keys:RequiredInlinedKeyedOneElementRangeList"
    )
...
class RequiredInlinedKeyedTwoElementRange(OptionalKeyedTwoElementRange):
    ...
    class_class_curie: ClassVar[str] = (
        "lists_and_keys:RequiredInlinedKeyedTwoElementRange"
    )
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        if self._is_empty(self.v1):
            self.MissingRequiredField("v1")
        self._normalize_inlined_as_dict(
            slot_name="v1", slot_type=KeyedTwoElementClass, key_name="name", keyed=True
        )
...
class RequiredInlinedKeyedTwoElementRangeList(OptionalKeyedTwoElementRangeList):
    ...
    class_class_curie: ClassVar[str] = (
        "lists_and_keys:RequiredInlinedKeyedTwoElementRangeList"
    )
...
class RequiredInlinedKeyedThreeElementRange(OptionalKeyedThreeElementRange):
    ...
    class_class_curie: ClassVar[str] = (
        "lists_and_keys:RequiredInlinedKeyedThreeElementRange"
    )
    ...
    v1: Union[
        dict[
            Union[str, KeyedThreeElementClassName], Union[dict, KeyedThreeElementClass]
        ],
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        self._normalize_inlined_as_dict(
            slot_name="v1",
            slot_type=KeyedThreeElementClass,
            key_name="name",
            keyed=True,
        )
...
class RequiredInlinedKeyedThreeElementRangeList(OptionalKeyedThreeElementRangeList):
    ...
    class_class_curie: ClassVar[str] = (
        "lists_and_keys:RequiredInlinedKeyedThreeElementRangeList"
    )
...
class RequiredInlinedIdentifiedOneElementRangeList(YAMLRoot):
    ...
    class_class_curie: ClassVar[str] = (
        "lists_and_keys:RequiredInlinedIdentifiedOneElementRangeList"
    )
    ...
    v1: Union[
        ...
        dict[
            Union[str, IdentifiedOneElementClassName],
            Union[dict, IdentifiedOneElementClass],
        ],
    ] = empty_dict()
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        ...
        self._normalize_inlined_as_dict(
            slot_name="v1",
            slot_type=IdentifiedOneElementClass,
            key_name="name",
            keyed=True,
        )
...
class EntryList(YAMLRoot):
    ...
    entries: Optional[
        Union[
            dict[
                Union[str, KeyedTwoElementClassName], Union[dict, KeyedTwoElementClass]
            ],
            list[Union[dict, KeyedTwoElementClass]],
        ]
    ] = empty_dict()
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        self._normalize_inlined_as_dict(
            slot_name="entries",
            slot_type=KeyedTwoElementClass,
            key_name="name",
            keyed=True,
        )
...
class OptionalIdentifiedThreeElementRange(YAMLRoot):
    ...
    class_class_curie: ClassVar[str] = (
        "lists_and_keys:OptionalIdentifiedThreeElementRange"
    )
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        if self.v1 is not None and not isinstance(
            self.v1, IdentifiedThreeElementClassName
        ):
            self.v1 = IdentifiedThreeElementClassName(self.v1)
...
class OptionalInlinedKeyedThreeElementRange(YAMLRoot):
    ...
    class_class_curie: ClassVar[str] = (
        "lists_and_keys:OptionalInlinedKeyedThreeElementRange"
    )
...
class RequiredInlinedIdentifiedThreeElementRange(YAMLRoot):
    ...
    class_class_curie: ClassVar[str] = (
        "lists_and_keys:RequiredInlinedIdentifiedThreeElementRange"
    )
...
class OptionalInlinedAsListKeyedThreeElementRange(YAMLRoot):
    ...
    class_class_curie: ClassVar[str] = (
        "lists_and_keys:OptionalInlinedAsListKeyedThreeElementRange"
    )
...
class RequiredInlinedAsListIdentifiedThreeElementRange(YAMLRoot):
    ...
    class_class_curie: ClassVar[str] = (
        "lists_and_keys:RequiredInlinedAsListIdentifiedThreeElementRange"
    )
...
class OptionalMultivaluedThreeElementRange(YAMLRoot):
    ...
    class_class_curie: ClassVar[str] = (
        "lists_and_keys:OptionalMultivaluedThreeElementRange"
    )
    ...
    v1: Optional[
        Union[Union[dict, ThreeElementClass], list[Union[dict, ThreeElementClass]]]
    ] = empty_list()
...
class RequiredMultivaluedThreeElementRange(YAMLRoot):
    ...
    class_class_curie: ClassVar[str] = (
        "lists_and_keys:RequiredMultivaluedThreeElementRange"
    )
...
class OptionalMultivaluedKeyedThreeElementRange(YAMLRoot):
    ...
    class_class_curie: ClassVar[str] = (
        "lists_and_keys:OptionalMultivaluedKeyedThreeElementRange"
    )
...
class RequiredMultivaluedIdentifiedThreeElementRange(YAMLRoot):
    ...
    class_class_curie: ClassVar[str] = (
        "lists_and_keys:RequiredMultivaluedIdentifiedThreeElementRange"
    )
...
class OptionalMultivaluedInlinedListIdentifiedThreeElementRange(YAMLRoot):
    ...
    class_class_curie: ClassVar[str] = (
        "lists_and_keys:OptionalMultivaluedInlinedListIdentifiedThreeElementRange"
    )
    ...
    v1: Optional[
        Union[
            dict[
                Union[str, IdentifiedThreeElementClassName],
                Union[dict, IdentifiedThreeElementClass],
            ],
    ...
    def __post_init__(self, *_: str, **kwargs: Any):
        self._normalize_inlined_as_list(
            slot_name="v1",
            slot_type=IdentifiedThreeElementClass,
            key_name="name",
            keyed=True,
        )
...
class RequiredMultivaluedInlinedListKeyedThreeElementRangeList(YAMLRoot):
    ...
    class_class_curie: ClassVar[str] = (
        "lists_and_keys:RequiredMultivaluedInlinedListKeyedThreeElementRangeList"
    )
    class_name: ClassVar[str] = (
        "RequiredMultivaluedInlinedListKeyedThreeElementRangeList"
    )
...
class OptionalMultivaluedInlinedIdentifiedThreeElementRangeList(YAMLRoot):
    ...
    class_class_curie: ClassVar[str] = (
        "lists_and_keys:OptionalMultivaluedInlinedIdentifiedThreeElementRangeList"
    )
    class_name: ClassVar[str] = (
        "OptionalMultivaluedInlinedIdentifiedThreeElementRangeList"
    )
...
class RequiredMultivaluedInlinedKeyedThreeElementRange(YAMLRoot):
    ...
    class_class_curie: ClassVar[str] = (
        "lists_and_keys:RequiredMultivaluedInlinedKeyedThreeElementRange"
    )
