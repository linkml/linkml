...
from linkml_runtime.linkml_model.types import Time
...
class GeographicLocation(YAMLRoot):
    ...
    class_class_uri: ClassVar[URIRef] = URIRef(
        "http://example.org/tests/timepoint/GeographicLocation"
    )
...
class GeographicLocationAtTime(GeographicLocation):
    ...
    class_class_uri: ClassVar[URIRef] = URIRef(
        "http://example.org/tests/timepoint/GeographicLocationAtTime"
    )
    class_class_curie: ClassVar[str] = None
