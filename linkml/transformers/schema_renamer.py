...
from linkml_runtime.linkml_model import SchemaDefinition, \
    ClassDefinition, SlotDefinition, TypeDefinition, EnumDefinition, \
    ClassDefinitionName, SlotDefinitionName, TypeDefinitionName, EnumDefinitionName, Element, ElementName
...
@click.option('-o', '--output',
              help="path to output schema")
@click.option('-C', '--class-names',
              help="function for class names")
@click.option('-S', '--slot-names',
              help="function for slot names")
