...
class Project(YAMLRoot):
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        self._normalize_inlined_as_dict(slot_name="source_google_sheet_docs", slot_type=GoogleSheetsDoc, key_name="id", keyed=True)
...
class Workspace(YAMLRoot):
    ...
    projects: Optional[Union[Dict[Union[str, ProjectName], Union[dict, Project]], List[Union[dict, Project]]]] = empty_dict()
...
slots.project__name = Slot(uri=WORKSPACE.name, name="project__name", curie=WORKSPACE.curie('name'),
                   model_uri=WORKSPACE.project__name, domain=None, range=URIRef)
...
slots.project__data_files = Slot(uri=WORKSPACE.data_files, name="project__data_files", curie=WORKSPACE.curie('data_files'),
                   model_uri=WORKSPACE.project__data_files, domain=None, range=Optional[Union[Union[str, FileSystemPath], List[Union[str, FileSystemPath]]]])

slots.project__source_google_sheet_docs = Slot(uri=WORKSPACE.source_google_sheet_docs, name="project__source_google_sheet_docs", curie=WORKSPACE.curie('source_google_sheet_docs'),
                   model_uri=WORKSPACE.project__source_google_sheet_docs, domain=None, range=Optional[Union[Dict[Union[str, GoogleSheetsDocId], Union[dict, GoogleSheetsDoc]], List[Union[dict, GoogleSheetsDoc]]]])

slots.project__project_directory = Slot(uri=WORKSPACE.project_directory, name="project__project_directory", curie=WORKSPACE.curie('project_directory'),
                   model_uri=WORKSPACE.project__project_directory, domain=None, range=Optional[Union[str, FileSystemPath]])

slots.project__external_project_path = Slot(uri=WORKSPACE.external_project_path, name="project__external_project_path", curie=WORKSPACE.curie('external_project_path'),
                   model_uri=WORKSPACE.project__external_project_path, domain=None, range=Optional[Union[str, FileSystemPath]])

slots.project__last_saved = Slot(uri=WORKSPACE.last_saved, name="project__last_saved", curie=WORKSPACE.curie('last_saved'),
                   model_uri=WORKSPACE.project__last_saved, domain=None, range=Optional[Union[str, XSDDateTime]])

slots.googleSheetsDoc__id = Slot(uri=WORKSPACE.id, name="googleSheetsDoc__id", curie=WORKSPACE.curie('id'),
                   model_uri=WORKSPACE.googleSheetsDoc__id, domain=None, range=URIRef)

slots.googleSheetsDoc__sheet_ids = Slot(uri=WORKSPACE.sheet_ids, name="googleSheetsDoc__sheet_ids", curie=WORKSPACE.curie('sheet_ids'),
                   model_uri=WORKSPACE.googleSheetsDoc__sheet_ids, domain=None, range=Optional[Union[str, List[str]]])

slots.gitHubAccount__username = Slot(uri=WORKSPACE.username, name="gitHubAccount__username", curie=WORKSPACE.curie('username'),
                   model_uri=WORKSPACE.gitHubAccount__username, domain=None, range=Optional[str])

slots.gitHubAccount__password = Slot(uri=WORKSPACE.password, name="gitHubAccount__password", curie=WORKSPACE.curie('password'),
                   model_uri=WORKSPACE.gitHubAccount__password, domain=None, range=Optional[str])

slots.workspace__projects = Slot(uri=WORKSPACE.projects, name="workspace__projects", curie=WORKSPACE.curie('projects'),
                   model_uri=WORKSPACE.workspace__projects, domain=None, range=Optional[Union[Dict[Union[str, ProjectName], Union[dict, Project]], List[Union[dict, Project]]]])

slots.workspace__github_account = Slot(uri=WORKSPACE.github_account, name="workspace__github_account", curie=WORKSPACE.curie('github_account'),
                   model_uri=WORKSPACE.workspace__github_account, domain=None, range=Optional[Union[dict, GitHubAccount]])

slots.workspace__projects_directory = Slot(uri=WORKSPACE.projects_directory, name="workspace__projects_directory", curie=WORKSPACE.curie('projects_directory'),
                   model_uri=WORKSPACE.workspace__projects_directory, domain=None, range=Optional[Union[str, FileSystemPath]])

slots.workspace__autosync = Slot(uri=WORKSPACE.autosync, name="workspace__autosync", curie=WORKSPACE.curie('autosync'),
                   model_uri=WORKSPACE.workspace__autosync, domain=None, range=Optional[Union[bool, Bool]])
