...
@click.option("--classes", "-c", default=None, show_default=True, multiple=True, help="Class(es) to emit")
@click.option("--map-fields", "-M", default=None, show_default=True, multiple=True, help="Map metamodel fields, e.g. slot=field")
