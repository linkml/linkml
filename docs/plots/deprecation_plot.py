...
deps.append(Deprecation(name="test-1", message="test", deprecated_in=SemVer.from_str("1.9.0"), removed_in=SemVer.from_str("2.1.0")))
deps.append(Deprecation(name="test-0", message="test", deprecated_in=SemVer.from_str("1.5.0"), removed_in=SemVer.from_str("1.6.5")))
deps.append(Deprecation(name="test-point", message="text", deprecated_in=SemVer.from_str("1.9.0")))
