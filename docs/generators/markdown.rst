...
Some static site/documentation generator frameworks (such as `mkdocs <https://www.mkdocs.org/>`) 
...
.. image:: docs/images/documentation_generation_schematic.png
...
that can be hosted on website hosting services like `GitHub Pages <https://pages.github.com/>`.
...
``gen-doc`` renders Mermaid UML `class diagrams <https://mermaid.js.org/syntax/classDiagram.html>` 
