...
* [linkml-project-copier](https://github.com/linkml/linkml-project-copier)
  - Build a new LinkML project conformant to best practices for directory layout, with lifecycle
    management for template updates, and a suite of autogenerated example schemas.
