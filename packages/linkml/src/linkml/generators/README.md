...
|  gen-prisma   | [prismagen.py](https://github.com/linkml/linkml/blob/main/linkml/generators/prismagen.py) | PrismaGenerator | generate Prisma schema for database ORM  | - |
