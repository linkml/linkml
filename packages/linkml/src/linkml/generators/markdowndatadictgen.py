...
class DiagramRenderer:
    ...
    def __init__(
        ...
        self.add_svg_links = add_svg_links
    ...
    def add_links_to_svg(self, svg_content: str) -> str:
        ...
        try:
            ...
            for text_elem in root.iter("{http://www.w3.org/2000/svg}text"):
                ...
                matched_class = None
                if text_content in self.class_names:
                    matched_class = text_content
                elif text_content.startswith("__") and text_content[2:] in self.class_names:
            ...
            svg_str = re.sub(r"<html:p>([^<]+)</html:p>", replace_class_name_in_p, svg_str)
            return svg_str
    ...
    def render(
        ...
        try:
            ...
            svg_content = self.add_links_to_svg(svg_content)
...
class MarkdownDataDictGen(Generator):
    ...
    def _initialize_generation(self, output: str, classes: set[ClassDefinitionName]) -> None:
        ...
        self._diagram_renderer = DiagramRenderer(
            ...
            add_svg_links=self.add_svg_links,
            class_names=self.schema_class_names,
        )
