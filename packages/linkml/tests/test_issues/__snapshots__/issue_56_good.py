...
slots.s1 = Slot(
    uri=DEFAULT_.s1, name="s1", curie=DEFAULT_.curie("s1"), model_uri=DEFAULT_.s1, domain=C1, range=Optional[str]
)

slots.s2 = Slot(
    uri=DEFAULT_.s2, name="s2", curie=DEFAULT_.curie("s2"), model_uri=DEFAULT_.s2, domain=C1, range=Optional[str]
)
