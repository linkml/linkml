...
slots.person__age = Slot(
    uri=EX.age, name="person__age", curie=EX.curie("age"), model_uri=EX.person__age, domain=None, range=Optional[int]
)
...
slots.Organization_parent = Slot(
    ...
    domain=Organization,
    range=Optional[Union[Union[dict, "Organization"], list[Union[dict, "Organization"]]]],
)
