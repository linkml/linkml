...
slots.id = Slot(uri=BIOLINK.id, name="id", curie=BIOLINK.curie("id"), model_uri=BIOLINK.id, domain=None, range=URIRef)

slots.name = Slot(
    uri=BIOLINK.name, name="name", curie=BIOLINK.curie("name"), model_uri=BIOLINK.name, domain=None, range=str
)

slots.age = Slot(
    uri=BIOLINK.age, name="age", curie=BIOLINK.curie("age"), model_uri=BIOLINK.age, domain=None, range=Optional[int]
)
