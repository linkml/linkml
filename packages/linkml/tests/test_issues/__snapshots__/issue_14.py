# Auto generated from issue_14.yaml by pythongen.py version: 0.0.1
...
slots.name = Slot(
    uri=DEFAULT_.name, name="name", curie=DEFAULT_.curie("name"), model_uri=DEFAULT_.name, domain=NamedThing, range=str
)

slots.subject = Slot(
    uri=DEFAULT_.subject,
    name="subject",
...
slots.object = Slot(
    uri=DEFAULT_.object,
    name="object",
    curie=DEFAULT_.curie("object"),
    model_uri=DEFAULT_.object,
    domain=None,
    range=Union[str, NamedThingId],
)

slots.sex_qualifier = Slot(
    uri=DEFAULT_.sex_qualifier,
    name="sex qualifier",
    curie=DEFAULT_.curie("sex_qualifier"),
    model_uri=DEFAULT_.sex_qualifier,
    domain=None,
    range=Optional[Union[str, NamedThingId]],
)

slots.mixin_owner_subject = Slot(
    uri=DEFAULT_.subject,
    name="mixin_owner_subject",
    curie=DEFAULT_.curie("subject"),
    model_uri=DEFAULT_.mixin_owner_subject,
    domain=MixinOwner,
    range=Union[str, SubjectRange1Id],
)

slots.mixin_class_object = Slot(
    uri=DEFAULT_.object,
    name="mixin_class_object",
    curie=DEFAULT_.curie("object"),
    model_uri=DEFAULT_.mixin_class_object,
    domain=MixinClass,
    range=Union[str, ObjectRange1Id],
)
