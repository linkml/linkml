...
from linkml_runtime.utils.metamodelcore import URI, Curie, ElementIdentifier, NCName, NodeIdentifier, URIorCURIE
...
slots.id = Slot(uri=M.id, name="id", curie=M.curie("id"), model_uri=M.id, domain=None, range=URIRef)
